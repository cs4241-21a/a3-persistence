...
Link: Been fighting for about 2 days with the deployment of my website. Ive tried deploying to glitch and heroku. Heroku is currently giving me an Internal Server Error. However, if I get it to work it will probably be here -> https://a3-carlos-velasquez.herokuapp.com/login 
