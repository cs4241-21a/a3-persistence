exports.creds = {
  ...
  redirectUrl: 'https://a3.edit2014.com/auth/openid/return',
...
exports.destroySessionUrl = 'https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri=https://a3.edit2014.com';
...
exports.databaseUri = process.env.SESSION_DB;

// How long you want to keep session in mongoDB.
exports.mongoDBSessionMaxAge = 60 * 15 //24 * 60 * 60;  // 1 day (unit is second)
